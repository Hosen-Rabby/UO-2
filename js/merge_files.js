...
function getBundlesForOrganization(orgID, context, privateKey)
{
    if ($("#shrtfrm").is(":visible")) {
            var currentform = $("#shrtfrm");
        } else {
    ...
    $.getJSON(url, function(data) 
    {
        ...
        if(statusCode == "200") //Everything is OK
        {
			...
			if (bundles.length == 1) {
				...
				html += "<tr><td height=\"10\"> </td></tr><tr width=\"408\"><td width=\"408\"><table width=\"408\"><tr><th width=\"5%\" style=\"padding:3px;\">&nbsp;</th><th width=\"5%\" style=\"padding:3px;\">&nbsp;</th>";
				html += "<th align=\"left\" width=\"20%\" style=\"padding:3px; vertical-align:bottom;\"><u>Name</u></th>";
				html += "<th align=\"left\" width=\"20%\" style=\"padding:3px; vertical-align:bottom;\"><u>1st<br/>Reminder</u></th>";
				html += "<th align=\"left\" width=\"20%\" style=\"padding:3px; vertical-align:bottom;\"><u>2nd<br/>Reminder</u></th>";
				html += "<th align=\"left\" width=\"30%\" style=\"padding:3px; vertical-align:bottom;\"><u>"+activityType+"<br/>In Bundle</u></th></tr></table>";
			}
        	...
        	$.each(bundles, function(index, object) //iterate through each set of bundle data
        	{
            	...
            	var str1;
            	var str2;
            	str1 = "<tr>\n<td width=\"5%\" style=\"padding:3px;\">&nbsp;</td><td width=\"5%\" style=\"padding:3px;\"><input type=\"radio\" name=\"bundle\" id=\"bundle\" value=\""+bundleID+"\" ";
				str2 = "/>\n</td><td align=\"left\" width=\"20%\" style=\"padding:3px;\">"+bundle+"</td>\n<td align=\"left\" width=\"20%\" style=\"padding:3px;\">"+dow1+"</td>";
				str2 += "<td align=\"left\" width=\"20%\" style=\"padding:3px;\">"+dow2+"</td><td align=\"left\" width=\"30%\" style=\"padding:3px;\">"+activityList+"</td></tr>\n";
...
*/
//INSERTS A NEW QUESTION INTO THE BOTTOM OF THE "INCLUDE" SECTION
function insertNewQuestionIntoDOM(question, id, isRequired)
{
      if ($("#shrtfrm").is(":visible")) {
            var currentform = $("#shrtfrm");
        } else {
...
function saveQuestionToDatabase(orgID, privateKey, question, answerType, countTowardMax, possibleValues, eventID, date, context, isRequired)

{
...

    {
...

        {
            ...
            insertNewQuestionIntoDOM(question, questionId, isRequired);
        }
...
function saveBundleToDatabase(orgID, privateKey, dow1, dow2, context)

{
...

    {
...

        {
        	...
        	getBundlesForOrganization(orgID, context, privateKey); 
...

{
 ...
 if ($("#shrtfrm").is(":visible")) {
	...
	saveQuestionToDatabase(orgID, privateKey, question, answerType, countTowardMax, possibleValues, eventID, date, context, isRequired);

}



function addBundle(orgID, context, privateKey)

{
 ...
 if ($("#shrtfrm").is(":visible")) {
	...
	saveBundleToDatabase(orgID, privateKey, dow1, dow2, context);
...
function insertEmptyQuestionElement(section)
{
    ...
    var htmlBefore = '<li id="empty-question" class="empty-question"><span>DRAG FILES HERE TO USE</span></li>';
    var htmlAfter = '<li id="empty-question" class="empty-question"><span>NO FILES</span></li>';
